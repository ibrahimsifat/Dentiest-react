    ...
    return (
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="md:flex">
          ...
          <button class="flex mt-4 md:mt-0 md:ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">Add to Cart</button>
...
export default DisplayAllProductsDetails;